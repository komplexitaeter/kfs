...
/* POST Parameters */
$station_id = filter_input(INPUT_POST, 'station_id', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
$items = filter_input(INPUT_POST, 'items', FILTER_SANITIZE_FULL_SPECIAL_CHARS);
